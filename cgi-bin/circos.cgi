...
print "<table><tr><td>";
print "Select the genome(s) to be displayed &nbsp;&nbsp;</td>";
#print "<td><select name=\"strains\" id=\"strains\" multiple size=10>\n";
print "<td><select name=\"strains\" id=\"strains\">\n";
...
print "</select></td>\n";
print "<td>&nbsp;&nbsp;<input class=\"btn btn-primary\" type=\"button\" value=\"Submit\" onclick=\"Circos('$Configuration::CGI_WEB_DIR','$session');\"></td>";
