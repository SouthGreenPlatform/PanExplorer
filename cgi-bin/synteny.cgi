...
<nav class="navbar navbar-default">
  <div class="container-fluid">
	...
	<li><a href="#" onClick="window.location='./home.cgi?project='+document.getElementById('project').value;">Home</a></li>
        ...
        <li class="active"><a href="#" onClick="window.location='./synteny.cgi?project='+document.getElementById('project').value;">Synteny</a></li>
...
print "<table><tr><td><b>Select 3 genomes for comparison</b><br/><br/>";
print "<p style=\"color:blue\">Genome1: <select name=\"strains1\" id=\"strains1\">\n";
foreach my $sample(sort @samples){
	if ($sample =~/ClutserID/){next;}
	print "<option value=\"$sample\">$sample</option>";
}
print "</select></p>\n";
print "<p style=\"color:red\">Genome2: <select name=\"strains2\" id=\"strains2\">\n";
foreach my $sample(sort @samples){
	if ($sample =~/ClutserID/){next;}
	print "<option value=\"$sample\">$sample</option>";
}
print "</select></p>\n";
print "<p style=\"color:#70B860\">Genome3: <select name=\"strains3\" id=\"strains3\">\n";
foreach my $sample(sort @samples){
	if ($sample =~/ClutserID/){next;}
	print "<option value=\"$sample\">$sample</option>";
}
print "</select></p>\n";
print "Highlight a cluster (it will be colored in yellow): <input type=\"txt\" name=\"cl\" id=\"cl\"><br/><br/>";
print "<input class=\"btn btn-primary\" type=\"button\" value=\"Submit\" onclick=\"Synteny('$Configuration::CGI_WEB_DIR','$session');\"></td>";
print "</tr></table>";
print "<br/>";
print "</form>\n";
