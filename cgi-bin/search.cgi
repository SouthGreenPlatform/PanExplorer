  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="#" onClick="window.location='./search.cgi?project='+document.getElementById('project').value;">Search</a></li>
...
print "<table><tr><td>";
print "Select the genome(s) in order to retrieve<br/>core-specific genes of this subset:&nbsp;&nbsp;</td>";
